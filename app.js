...
var NFA_DEM_ARTICLES = [
  ...
  {t:'Poll shows Vivek Ramaswamy is among few Ohioans not leery of data centers | Opinion',d:'With the opposition to data centers, it\'s interesting Ohio candidates have mostly stayed quiet  or, in Ramaswamys case, taken a stance at odds with vo',l:'https://www.dispatch.com/story/opinion/columns/guest/2026/06/04/data-center-poll-ohio-amy-acton-vivek-ramaswamy-jon-husted-sherrod-brown/90364018007/',i:'https://www.dispatch.com/gcdn/authoring/authoring-images/2026/05/19/NCOD/90160545007-news-ramaswamy-medicaid-presser-06.jpg?crop=7007,3943,x0,y364&width=1600&height=800&format=pjpg&auto=webp'},
  {t:'Bucks Co. Congressman Votes With Democrats To Pass War Powers Resolution',d:'Four Republicans crossed the aisle on Wednesday to join the Democrats in passing the resolution, which would end the war with Iran.',l:'https://patch.com/pennsylvania/doylestown/bucks-co-congressman-votes-democrats-pass-war-powers-resolution',i:'https://patch.com/img/cdn20/users/26019821/20260604/042337/styles/patch_image/public/fitzpatrick2___04041840777.jpg'},
  {t:'Medicare and Medicaid Fraud Are Here to Stay',d:'Today, were looking at the ramifications of New Yorks Good Cause Eviction law, Texass effort to attract business, and a moral hierarchy among murderer',l:'https://www.city-journal.org/article/city-journal-daily-newsletter-jun-4-2026',i:'https://virtuous-email.s3.amazonaws.com/Email/org_5718/CJ%20Logo%20Black-Teal.png'},
  {t:'Trump to nominate Blanche for attorney general on permanent basis',d:'If confirmed by the Senate, Trump\'s former personal lawyer would become the administration\'s number one prosecutor.',l:'https://www.bbc.com/news/articles/c4g8nyzl2pno',i:'https://ichef.bbci.co.uk/news/1024/branded_news/8144/live/dd1d00d0-5fb9-11f1-8032-ed99bad5f9b6.jpg'},
  {t:'Rubio Rips Deranged Democrats During Appearance Before House Foreign Affairs Committee, Is This a Ci',d:'Rubio exasperated and annoyed by Democrats in appearance before House Foreign Affairs Committee. Secretary of State Marco Rubio blasts the Foreign Aff',l:'https://beforeitsnews.com/opinion-conservative/2026/06/rubio-rips-deranged-democrats-during-appearance-before-house-foreign-affairs-committee-is-this-a-circus-3740869.html',i:'https://s.w.org/images/core/emoji/17.0.2/72x72/1f6a8.png'},
];
...
var NFA_REP_ARTICLES = [
  ...
  {t:'Poll shows Vivek Ramaswamy is among few Ohioans not leery of data centers | Opinion',d:'With the opposition to data centers, it\'s interesting Ohio candidates have mostly stayed quiet  or, in Ramaswamys case, taken a stance at odds with vo',l:'https://www.dispatch.com/story/opinion/columns/guest/2026/06/04/data-center-poll-ohio-amy-acton-vivek-ramaswamy-jon-husted-sherrod-brown/90364018007/',i:'https://www.dispatch.com/gcdn/authoring/authoring-images/2026/05/19/NCOD/90160545007-news-ramaswamy-medicaid-presser-06.jpg?crop=7007,3943,x0,y364&width=1600&height=800&format=pjpg&auto=webp'},
  {t:'Bucks Co. Congressman Votes With Democrats To Pass War Powers Resolution',d:'Four Republicans crossed the aisle on Wednesday to join the Democrats in passing the resolution, which would end the war with Iran.',l:'https://patch.com/pennsylvania/doylestown/bucks-co-congressman-votes-democrats-pass-war-powers-resolution',i:'https://patch.com/img/cdn20/users/26019821/20260604/042337/styles/patch_image/public/fitzpatrick2___04041840777.jpg'},
  {t:'Former Trump adviser John Bolton to plead guilty to retaining national security information',d:'John Bolton, former US national security adviser, arrives at the US district courthouse in Greenbelt, Maryland, US, on Friday, Oct. 17, 2025.',l:'https://www.nbcboston.com/news/national-international/john-bolton-plead-guilty-national-security-information/3960176/',i:'https://media.nbcboston.com/2026/06/John-Bolton-Indicted-Over-Handling-Of-Classified-D-2241173893-Getty.jpg?quality=85&strip=all&fit=4000,2663'},
  {t:'Douglas Cohn and Eleanor Clift: Trump\'s actions keep shrinking his coalition',d:'Republicans make up 28% of the population and MAGA Republicans are 43% of them, at 12% of the population. Right-leaning independents have provided ano',l:'https://www.dailyadvance.com/opinion/editorial_columnists/douglas-cohn-and-eleanor-clift-trumps-actions-keep-shrinking-his-coalition/article_f13cf616-3b52-5027-b6b8-713363a0e39e.html',i:'https://bloximages.newyork1.vip.townnews.com/dailyadvance.com/content/tncms/assets/v3/editorial/2/3f/23f7f6c6-9ca1-5097-87ec-b3f410a0fa0b/64dfa75c136d7.image.jpg?crop=360%2C360%2C0%2C82&resize=200%2C200&order=crop%2Cresize'},
];
...
function populateNewsFeeds() {
  ...
  if (demEl && typeof NFA_DEM_ARTICLES !== 'undefined' && NFA_DEM_ARTICLES.length) {
    demEl.innerHTML = NFA_DEM_ARTICLES.slice(0,3).map(function(a){ return makeCard(a,'#0066cc'); }).join('');
  }
  if (repEl && typeof NFA_REP_ARTICLES !== 'undefined' && NFA_REP_ARTICLES.length) {
    repEl.innerHTML = NFA_REP_ARTICLES.slice(0,3).map(function(a){ return makeCard(a,'#cc0000'); }).join('');
  }
}
